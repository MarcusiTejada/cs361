...
public class DemoEmployee {
	...
	public static void main(String[] args) {
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI () // prints "PART TIME EMPLOYEE" because eamp3 is a copy of pEmp2 who is also a
		//					 part time employee. Both objects have the same pointers to the same data in
		//					 memory.
		// emp3.getHourlyRate(); // returns syntax error because although eamp3 is a copy of a PartTimeEmployee
		//							object it does not store the same exact data. Employee objects do not have
		//							HourlyRate parameter so when all the other parameters were copied it left out
		//							the ones that the Employee object could not hold because it did not share it.
		...
		// because although emp1 is being typecasted into a PartTimeEmployee object
		// emp1 is actually an instance of Employee an employee object and because of the rules of
		// Downcasting would not work.
